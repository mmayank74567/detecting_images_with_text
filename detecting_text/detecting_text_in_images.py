...
class DetectingText():
    ...
    def non_max_suppression(self, boxes, probs=None, overlapThresh=0.3):
    	...
    	# is important as it will undergo a bunch of divisions
    ...
    def east_detection(self, image, conf = 0.5, width = 320, height = 320):
            #height and width should be a multiple of 320
